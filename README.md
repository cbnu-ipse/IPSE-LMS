<h1 align="center">💻 IPSE LMS: 차세대 AI 및 알고리즘 학술 동아리 플랫폼</h1>
...
1. [프로젝트 개요](#-프로젝트-개요)
2. [시스템 아키텍처 및 기술 스택](#-시스템-아키텍처-및-기술-스택)

<br>

## 📌 프로젝트 개요

충북대학교 AI 및 알고리즘 학술 동아리 IPSE 동아리 관리 시스템(LMS)입니다. IPSE 동아리 부원들의 커뮤니티 형성을 위해 개발되었습니다.
