...
urlpatterns = [
    ...
    path("balance-game/", views.balance_game_view, name="balance_game"),
    path("balance-game/score/", views.save_balance_score, name="balance_game_score"),
    path("balance-game/ranking/", views.balance_game_ranking, name="balance_game_ranking"),
